...
Function 'w3' grad(u3)
Function 'Hdiff3' difference between data and forward problem output for 3rd bc

Output :
Function 'x1' delta_sigma, solution of the inverse problem
"""

def NewtonIterFull (mesh ,w0 ,sigma ,alpha ,Hdiff ,V,Vg, w2, Hdiff2, w3, Hdiff3):  #nzig: none_ero_intial_guess

    # Define function space
    W = FunctionSpace (mesh,MixedElement([V, V, V,Vg ,V,Vg,V,Vg]))
    # Define trial and test functions
    (deltas ,deltau ,deltaz ,deltaw , deltau2 , deltaw2,deltau3 , deltaw3)= split ( TrialFunction (W))
    (v1 ,v2 ,v3 ,v4 ,v5 ,v6 ,v7 ,v8) = split ( TestFunction (W))

    #Define boundary condition(s)
    bc1 = DirichletBC (W.sub(1), 0.0, "on_boundary")
    bc4 = DirichletBC (W.sub(4), 0.0, "on_boundary")
    bc6 = DirichletBC (W.sub(6), 0.0, "on_boundary")
    ...
    a = a+Q2(deltaz ,deltaw[2] ,w0[2])* Q2(v3 ,v4[2] ,w0[2])
    a = a+(deltas - deltaz )*(v1 -v3)
    a = a+G(deltau ,deltaw ,v2 ,v4)
    a = a+Reg(deltas , deltau )
    a = a+Q1(deltaz , deltaw2 ,w2 )* Q1(v3 ,v6 ,w2)
    a = a+Q1(deltaz , deltaw3 ,w3 )* Q1(v3 ,v8 ,w3)
    a = a+Q2(deltaz , deltaw2[0] ,w2[0])* Q2(v3 ,v6[0] ,w2[0])
    a = a+Q2(deltaz , deltaw3[0] ,w3[0])* Q2(v3 ,v8[0] ,w3[0])
    a = a+Q2(deltaz , deltaw2[1] ,w2[1])* Q2(v3 ,v6[1] ,w2[1])
    a = a+Q2(deltaz , deltaw3[1] ,w3[1])* Q2(v3 ,v8[1] ,w3[1])
    a = a+Q2(deltaz , deltaw2[2] ,w2[2])* Q2(v3 ,v6[2] ,w2[2])
    a = a+Q2(deltaz , deltaw3[2] ,w3[2])* Q2(v3 ,v8[2] ,w3[2])
    a = a+G( deltau2 , deltaw2 ,v5 ,v6)+G( deltau3 , deltaw3 ,v7 ,v8)
    a = a+alpha * deltau2 *v5+ alpha * deltau3 *v7
    a = a*dx


    L=Lfun (Hdiff[0] ,v3 ,v4[0] ,w0[0])+Lfun (Hdiff[1] ,v3 ,v4[1] ,w0[1])+Lfun (Hdiff[2] ,v3 ,v4[2] ,w0[2])
    L=L+Lfun ( Hdiff2[0] ,v3 ,v6[0] ,w2[0])+Lfun ( Hdiff2[1] ,v3 ,v6[1] ,w2[1])+Lfun(Hdiff2[2] ,v3 ,v6[2] ,w2[2])
    L=L+Lfun ( Hdiff3[0] ,v3 ,v8[0] ,w3[0])+Lfun ( Hdiff3[1] ,v3 ,v8[1] ,w3[1])+Lfun(Hdiff3[2] ,v3 ,v8[2] ,w3[2])
    L=L*dx
    

    # Solve the system
    w = Function (W)
    problem = LinearVariationalProblem(a, L, w, [bc1, bc4, bc6])
    ...
    (x1 ,x2 ,x3 ,x4 ,x5 ,x6,x7,x8) = w. split ( deepcopy = True )
