...
def NewtonIterFull (mesh ,w0 ,sigma, alpha ,Hdiff ,V,Vg ,w2, Hdiff2,w3, Hdiff3):
    ...
    def Q2(deltaz ,deltaw ,w0 ,w0sqr ,new= False ):
        q2 = deltaz *pwd + sigma *( pwd / w0sqr )*\
        inner (w0 , deltaw )
        return q2
    ...
    def Lfun (Hdiff ,v3 ,v4 ,w0 ,w0sqr ,pwd ):
        l1 = Hdiff *( v3 *pwd + sigma *( pwd / w0sqr )\
                     * inner (w0 , v4 ))
        return l1
    ...
    a = a+ Q2(deltaz ,deltaw ,w0 , w0sqr )* Q2(v3 ,v4 ,w0 , w0sqr )
    ...
    a = a + Q2(deltaz , deltaw2 ,w2 , w2sqr )* Q2(v3 ,v6 ,w2 , w2sqr )
    a = a + Q2(deltaz , deltaw3 ,w3 , w3sqr )* Q2(v3 ,v8 ,w3 , w3sqr )
    a = a + G( deltau2 , deltaw2 ,v5 ,v6)+G( deltau3 , deltaw3 ,v7 ,v8)
    a = a + alpha * deltau2 *v5+ alpha * deltau3 *v7
    a = a* dx
    
    L = Lfun (Hdiff ,v3 ,v4 ,w0 ,w0sqr ,pwd )
    L = L + Lfun ( Hdiff2 ,v3 ,v6 ,w2 ,w2sqr , pwd2 )
    L = L + Lfun ( Hdiff3 ,v3 ,v8 ,w3 ,w3sqr , pwd3 )
    L = L * dx
